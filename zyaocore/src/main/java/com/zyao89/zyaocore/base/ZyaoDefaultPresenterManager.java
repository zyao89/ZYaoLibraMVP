...
import com.zyao89.zyaocore.base.presenter.ZyaoPresenterBuilder;
import com.zyao89.zyaocore.base.presenter.ZyaoPresenterManager;

import java.util.HashMap;


public class ZyaoDefaultPresenterManager extends ZyaoPresenterManager
{

	//使用id当索引保持所有presenter引用，虽然view与presenter是一一对应关系。但避免保持View引用
	private HashMap<String, ZyaoBasePresenter> idToPresenter = new HashMap<>();
	private int nextId;

	@Override
	public <T extends ZyaoBasePresenter> T create(Object view)
	{
		T presenter = ZyaoPresenterBuilder.fromViewClass(view.getClass());
		if (presenter == null)
			return null;
	...
	@Override
	public <T extends ZyaoBasePresenter> T get(String id)
	{
